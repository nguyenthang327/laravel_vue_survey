  ...
  <PageComponent>
    <template v-slot:header>
      <div class="flex justify-between items-center">
        <h1 class="text-3xl front-bold text-gray-900">Surveys</h1>
        <router-link
      ...
      >
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          <button
            ...
            class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offet-2 focus:ring-red-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
